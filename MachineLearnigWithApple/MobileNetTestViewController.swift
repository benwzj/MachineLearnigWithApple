...
class MobileNetTestViewController: UIViewController {
    ...
    let semaphore = DispatchSemaphore(value: MobileNetTestViewController.maxInflightBuffers)
    ...
    func setUpVision() {
      ...
      for _ in 0..<MobileNetTestViewController.maxInflightBuffers {
    ...
    func predictUsingVision(pixelBuffer: CVPixelBuffer) {
      ...
      inflightBuffer += 1
      if inflightBuffer >= MobileNetTestViewController.maxInflightBuffers {
        inflightBuffer = 0
      }
...
extension MobileNetTestViewController: VideoCaptureDelegate {
